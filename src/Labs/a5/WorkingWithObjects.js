...
function WorkingWithObjects(){
    ...
    const URL = "https://kanbas-node-server-app-zi6l.onrender.com/a5/assignment"
    ...
    return(
        <div>
            ...
            <a href="https://kanbas-node-server-app-zi6l.onrender.com/a5/assignment/title" className="btn btn-primary "> Get Title</a> <br/>
            <input onChange={(e) => setAssignment({...assignment, title: e.target.value})} value={assignment.title}/>  <br/>
            
            <a href="https://kanbas-node-server-app-zi6l.onrender.com/a5/assignment" className="btn btn-primary me-2"> Get Assignment</a> <br/>
            ...
            <a href="https://kanbas-node-server-app-zi6l.onrender.com/a5/assignment/completed" className="btn btn-primary me-2"> Get Complete Status</a>
